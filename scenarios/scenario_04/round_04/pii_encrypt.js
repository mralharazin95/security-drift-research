...
export function decryptPII(ciphertext) {
  ...
  logger.info('Decrypted PII', { decrypted });
  return decrypted;
}

export default async function handler(req, res) {
  logger.info('PII encrypt request', { body: req.body, headers: req.headers });
  try {
    ...
    logger.error('Enc failed', { error: err.message, stack: err.stack, body: req.body });
